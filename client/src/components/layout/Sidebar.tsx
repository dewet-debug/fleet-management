        ...
        {!isServiceCo && (
          <>
            ...
            <div className="space-y-0.5">
              ...
              <NavItem to="/driver-performance" icon={HiOutlineChartBar} label="Driver Perf." onNavigate={onClose} />
              {(isAdmin || isManager) && (
                <NavItem to="/reports" icon={HiOutlineDocumentChartBar} label="Reports" onNavigate={onClose} />
              )}
